...
function createArticleComponent(title, date, blog){
  ...
  const articleParagraph= blog.map(artp => {
    const parag = document.createElement('p');
    parag.textContent = artp;
  ...
  articleParagraph.forEach(artp=>{
    articleSection.appendChild(artp)
  })
